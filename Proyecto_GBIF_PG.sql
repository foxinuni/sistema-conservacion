...
drop table Amenaza cascade;
drop table Biodiversidad cascade;
drop table Area_Amenazada cascade;
drop table Ref_Indicador cascade;
drop table Indicador cascade;
drop table Observacion cascade;
drop table Actividad_Conservacion cascade;
drop table Area_Protegida cascade;
drop table Especie cascade;
drop table Estado_conservacion cascade;
...
create table Estado_conservacion(
    ...
    definicion_estado varchar(2500),
	primary key (ID)
);
...
create table Especie (
     ...
     carateristicas_fisicas  varchar(2500),
	 habitad                 varchar(2500),
     ID_estado_conservacion  varchar(6),
	 primary key (ID),
...
create table Area_Protegida
    (ID                  varchar(6),
     ID_observacion      varchar(6),
     nombre              varchar(200),
     ubicacion_latitud   numeric(9,5),
     ubicacion_longitud  numeric(9,5),
     extension           numeric(9,2),
     tipo_ecosistema     varchar(200),
     fecha_creacion      date,
     primary key (ID),
...
create table Amenaza
    (ID     		    varchar(6),
    nombre_amenaza          varchar(50),
    descripcion         varchar(2300),
    primary key (ID)
);
...
create table Biodiversidad
    (ID     		    varchar(6),
    nombre_biodiversidad          varchar(30) unique,
    descripcion         varchar(2500),
    primary key (ID)
);
